...
- Atualização dos valores Q usando SARSA
...
class SarsaAgent:
    ...
    def learn(self, state, action, reward, next_state):
        # Escolher próxima ação usando a política atual (diferença do Q-Learning)
        next_action = self.choose_action(next_state)
        
        # Atualizar valor Q usando a equação do SARSA
